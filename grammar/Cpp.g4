...
globalDefinition: variableDeclaration | functionDefinition | classDefinition | arrayDeclaration;
...
classDefinitionItem: variableDeclaration | functionDefinition | ctorDefinition | accessSpecifier | arrayDeclaration;
...
statement: variableDeclaration | coutStatement | cinStatement | returnStatement | ifStatement | whileStatement | forStatement | switchStatement | breakStatement | continueStatement | assignmentStatement | expressionStatement | arrayDeclaration;
...
useIdentifier: (thisPrefix | baseClassPrefix)? identifier ((DOT | ARROW) identifier)* | arrayItem;
