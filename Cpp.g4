...
// Parser rules
program: statement*;
statement: namespace | enum | variable | function | while_loop | switch_case | if_else | expression SEMICOLON | return_statement | break_statement | continue_statement | throw_statement | using_directive | for_loop | for_each_loop | try_catch_block;
...
function: some_type ID LEFT_PAREN parameter_list? RIGHT_PAREN scope;
...
while_loop: WHILE LEFT_PAREN expression RIGHT_PAREN scope_or_statement;
...
if_else: IF LEFT_PAREN expression RIGHT_PAREN scope_or_statement (ELSE IF LEFT_PAREN expression RIGHT_PAREN scope_or_statement)* (ELSE scope_or_statement)?;
lambda_expression: LEFT_SQ labda_captures? RIGHT_SQ LEFT_PAREN parameter_list? RIGHT_PAREN scope;
...
for_loop: FOR LEFT_PAREN (variable | expression SEMICOLON | SEMICOLON) expression SEMICOLON expression RIGHT_PAREN scope;
for_each_loop: FOR LEFT_PAREN some_type ID COLON expression RIGHT_PAREN scope;
try_catch_block: TRY scope (CATCH LEFT_PAREN some_type ID? RIGHT_PAREN scope)*;
